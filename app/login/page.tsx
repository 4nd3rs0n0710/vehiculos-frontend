 ...
 * Página de Login.
 *
 * Responsabilidad única (SRP): solo renderiza la UI.
 * Toda la lógica de negocio está en useLoginForm.
 */
...
import { useLoginForm, LOGIN_CONSTRAINTS, LOGIN_MESSAGES } from '@/lib/useLoginForm'
...
function LoginForm() {
  ...
  const {
    username, password, showPass, error,
    loading, showExpired,
    setUsername, setPassword, setShowPass,
    handleSubmit,
  } = useLoginForm(expired)
    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-12 mt-32">
          ...
          {showExpired && (
            <AnimatePresence>
              ...
              >
                {LOGIN_MESSAGES.SESSION_EXPIRED}
              </motion.div>
            </AnimatePresence>
          )}
          ...
          <div>
            ...
            <input
              ...
              required
              maxLength={LOGIN_CONSTRAINTS.MAX_USERNAME_LENGTH}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••••••••"
                required
                maxLength={LOGIN_CONSTRAINTS.MAX_PASSWORD_LENGTH}
                style={{ fontFamily: 'var(--font-montserrat)', lineHeight: '48px', boxSizing: 'border-box' }}
                className="w-full h-[48px] pl-5 pr-12 rounded-full border border-[#E5E5E5] bg-transparent text-[15px] text-[#40CEE4] font-medium placeholder:text-[#40CEE4] placeholder:font-medium placeholder:opacity-90 focus:outline-none focus:border-[#40CEE4] transition-all appearance-none"
              />
              <button
                type="button"
        ...
        <div className="mt-auto pt-10 flex justify-center gap-6">
          <div className="w-[64px] h-[64px] rounded-2xl bg-[#FCFCFC] shadow-[0_2px_8px_rgba(0,0,0,0.08)] flex items-center justify-center text-[#40CEE4] cursor-pointer hover:bg-[#40CEE4]/10 transition-all border border-[#40CEE4]/20">
            <HelpCircle size={28} strokeWidth={1.8} />
          </div>
          <div className="w-[64px] h-[64px] rounded-2xl bg-[#FCFCFC] shadow-[0_4px_12px_rgba(0,0,0,0.12)] flex items-center justify-center text-[#40CEE4] cursor-pointer hover:bg-[#40CEE4]/10 transition-all border border-[#40CEE4]/20">
